...
Please do NOT make changes to spoken text for clarity of meaning (though these can be added as a NOTE), 
as this will break captioning such that when watching video the spoken words won't match the text. 
